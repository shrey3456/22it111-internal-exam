...
const RecruitorCandidateCard = ({ data }: ICandidateCardProps) => {
  return (
    <div className="relative px-3.5 py-5 border border-gray-700 rounded-md shadow-sm shadow-gray-700 group transitions hover:shadow-md">
      ...
      <div className="flex flex-col items-center justify-center text-center pt-[25px]">
        ...
        <div className="flex items-center justify-center gap-2.5 mt-6">
          <button
            type="button"
            className="primary-btn bg-red-500 px-[20px] h-[35px] flex items-center text-sm font-poppin justify-center leading-none"
            onClick={() => {
              window.scrollTo({
                top: 0,
              });
...
export default RecruitorCandidateCard;
