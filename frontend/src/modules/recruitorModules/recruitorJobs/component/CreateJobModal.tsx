...
import { useCreateJobMutation } from "../../../../redux/features/jobApi";
import { toast } from "react-toastify";

const CreateJobModal = ({ id }: { id: string }) => {
    ...
    <Modal id={id}>
      <div className="modal-box max-w-[600px] bg-light-blue">
        <h3 className="font-jakarta text-white font-bold text-center text-[25px] text-heading-color ">
          Create <span className="text-green">Job</span>
        </h3>
        ...
        >
          ...
          <div className="col-span-full">
            ...
            <textarea
              className="resize-none mt-1 text-xs w-full h-[150px] p-1.5 text-slate rounded-md border border-[#94a3b857] bg-transparent focus:outline-none focus:border-green"
